...
li_thresholded = denoised > filters.threshold_li(denoised)  #takes every array value in denoised that is larger than threshold val and 0 intensity for other vals
...
remove_holes = morphology.remove_small_holes(
    filled, 
    area_threshold=width ** 3 # approximated as cube - we are still dealing with 3d image array!
)
...
viewer.add_image(edges, blending='additive', colormap='magenta', contrast_limits=[0,1], name='edges')
